...
const LopHocPhanModel = require('../models/lophocphan.model'); // Đảm bảo đường dẫn đúng
const SinhVienModel = require('../models/sinhvien.model'); // Đảm bảo đường dẫn đúng
const SinhVienLopHPModel = require('../models/sinhvienlophp.model'); // Đảm bảo đường dẫn đúng
const LichHocModel = require('../models/lichhoc.model'); // Đảm bảo đường dẫn đúng
